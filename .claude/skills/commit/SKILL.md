...
1. Export the current conversation and save it to a file in the `.prompts` folder representing today's date (for example, 20260217.txt). If such a file already exists, do not override what's there, simply append.
